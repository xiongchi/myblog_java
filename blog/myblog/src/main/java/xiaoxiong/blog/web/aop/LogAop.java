...
public class LogAop {
    ...
    @Pointcut("@annotation(xiaoxiong.blog.web.annotations.ControlAnno)")
    public void controllerLogPointCut(){
    }

    @Pointcut("@annotation(xiaoxiong.blog.web.annotations.MethodLogAnno)")
    ...
    public void methodLogBefore(JoinPoint joinPoint){
        ...
        MethodLogAnno annotation = method.getAnnotation(MethodLogAnno.class);
    ...
    public Object controllerLogAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        Method method = sign.getMethod();
        ControlAnno annotation = method.getAnnotation(ControlAnno.class);
        // 记录开始时间
